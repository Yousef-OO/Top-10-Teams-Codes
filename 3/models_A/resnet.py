...
from models_A.se_module import SELayer

__all__ = ['ResNet', 'resnet18', 'resnet34', 'resnet50', 'resnet101',
           'resnet152','se_resnet34']
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=config.num_classes):
        self.inplanes = 64
        super(ResNet, self).__init__()
        self.conv1 = nn.Conv1d(8, 64, kernel_size=15, stride=2, padding=7,#原来是8
                               bias=False)
