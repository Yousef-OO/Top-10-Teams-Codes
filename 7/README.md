...
`docker run -v /media/data_ssd_1t/ECGnet/data_students/cinc2020/training_combined/:/physionet/in -it cinc:cuda_test`
`python driver.py output_training_directory/ in/ out/`
...
~/docker_test/input_directory:/physionet/input_directory -v ~/docker_test/output_directory:/physionet/output_directory`