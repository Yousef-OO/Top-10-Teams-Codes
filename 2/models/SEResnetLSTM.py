...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, in_channel=1, out_channel=10, zero_init_residual=False):
        ...
        self.bigru = nn.GRU(512 * block.expansion, 512 * block.expansion, num_layers=1,
                            bidirectional=True, batch_first=True, bias=False)

        self.activation = nn.Sequential(nn.BatchNorm1d(512 * block.expansion * 2), nn.LeakyReLU(0.3, inplace=True), nn.Dropout(.2),)
